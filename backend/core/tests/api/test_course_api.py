...
class TestCreateSection:
    def test_success(self, mock_course_persistence):
    ...
    def test_fail(self, mock_course_persistence):
        course_api = CourseApi(mock_course_persistence)
        section = fake_section()
        err = Err(fake.pystr())
...
def test_query_courses(mock_course_persistence, filters, expected):
    course_api = CourseApi(mock_course_persistence)
...
def test_get_course(mock_course_persistence, expected):
    course_api = CourseApi(mock_course_persistence)
...
def test_get_section(mock_course_persistence, expected):
    course_api = CourseApi(mock_course_persistence)
